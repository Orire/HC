...
const categories =
{
    ...
    "משפחה וקשרים": ["אני", "אתה","אבא", "אמא", "אחות", "אהובתי", "חבר", "אישה"],
    "כינויים וקללות": ["אידיוט", "גאון", "חרא!", "תענוג", "מותק", "די!", "מי אתה?", "כןס אמק!", "בנזונה", "זבל"],
    ...
    "ים": [ "מטקות","גל", "חול", "מלח", "דג", "אלמוג", "מדוזה", "עוגן", "סירה", "צדפה", "צוללת"],
